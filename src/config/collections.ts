...
> = {
  ...
  items: {
    ...
    eyebrow: "How to Fish Wiki",
    description:
      "Check where each documented item is obtained, what it does and whether it must be kept for a quest, boss trigger, achievement or island unlock.",
    href: "/wiki/items/",
    detailPrefix: "/wiki/items",
    image: "/images/official/gameplay-01.jpg",
  },
  bait: {
    title: "How to Fish Steam Bait Guide: Lures, Prices & Catch Lists",
    seoTitle: "Bait & Lures — Catch List & Prices",
    breadcrumb: "Bait & Lures",
    eyebrow: "How to Fish Wiki",
    description:
      "Match every documented bait, lure and carried trigger with its catch pool, compatible rod, island, shop price and connected boss or quest route.",
    href: "/wiki/bait/",
