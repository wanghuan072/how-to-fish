...
function WikiCatalog({ collection, entries, config }: { collection: CollectionKey; entries: ContentEntry[]; config: DirectoryConfig }) {
  const layouts: Partial<Record<CollectionKey, Array<{ id: string; title: string; description: string; slugs: string[] }>>> = {
    ...
    npcs: [
      { id: "lighthouse-npcs", title: "Lighthouse", description: "Opening companions and the first progression hand-in.", slugs: ["lighthouse-keeper", "melvin"] },
      { id: "forest-npcs", title: "Forest Island", description: "The Leech Bait and Giant Piranha route.", slugs: ["forest-lake-lady"] },
      { id: "desert-npcs", title: "Desert Island", description: "The Carrot, Pufferfish and cooking routes.", slugs: ["desert-tourist", "grillmaster"] },
      { id: "rocks-npcs", title: "Rocks Island", description: "The Tuna-to-Albatross hand-in for Volcano coordinates.", slugs: ["rocks-shop-npc"] },
    ],
  };
