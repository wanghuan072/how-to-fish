    ...
    <main id="main-content">
      ...
      <section className={styles.paper}>
        <div className={styles.layout}>
          <aside className={styles.sidebar}><h2>Achievement Types</h2><nav>{groups.map((group) => <a href={`#${group.id}`} key={group.id}><span>{group.title}</span><b>{group.names.length}</b></a>)}<Link href="/tools/"><span>Kill Bonus Tools</span><b>20</b></Link></nav></aside>
